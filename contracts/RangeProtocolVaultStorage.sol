...
abstract contract RangeProtocolVaultStorage is IRangeProtocolVault {
    ...
    function priceOracleX() external view override returns (address) {
        return state.priceOracleX;
    }

    function priceOracleY() external view override returns (address) {
        return state.priceOracleY;
    }
    ...
    function otherBalanceX() external view override returns (uint256) {
        return state.otherBalanceX;
    }

    function otherBalanceY() external view override returns (uint256) {
        return state.otherBalanceY;
    }
