...
abstract contract RangeProtocolVaultStorage is IRangeProtocolVault {
    ...
    function bottomTick() external view override returns (int24) {
        return state.bottomTick;
    }

    function topTick() external view override returns (int24) {
        return state.topTick;
    }
    ...
    function pool() external view override returns (IAlgebraPool) {
        return state.pool;
    }
