...
interface IRangeProtocolVault is IERC20Upgradeable, IAlgebraMintCallback, IAlgebraSwapCallback {
    event Minted(
    ...
    // GETTER FUNCTIONS
    function bottomTick() external view returns (int24);

    function topTick() external view returns (int24);
